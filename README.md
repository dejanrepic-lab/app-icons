...
Public icon assets for self-hosted applications and dashboards.

These files are intended for direct use in tools such as ZimaOS and Homarr.
...
Use the raw GitHub URLs for direct icon loading:
